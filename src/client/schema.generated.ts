...
export const generatedSchema = {
  ...
  SEOPress: {
    ...
    hasProLicense: { __type: "Boolean" },
    metaDesc: { __type: "String" },
    metaNewsDisabled: { __type: "Boolean" },
    metaRobotsArchive: { __type: "Boolean" },
    metaRobotsBreadcrumbs: { __type: "String" },
    metaRobotsImageIndex: { __type: "Boolean" },
    metaRobotsNofollow: { __type: "Boolean" },
    metaRobotsNoindex: { __type: "Boolean" },
    metaRobotsOdp: { __type: "Boolean" },
    metaRobotsPrimaryCategory: { __type: "Int" },
    metaRobotsSnippet: { __type: "Boolean" },
    metaTitle: { __type: "String" },
    metaVideo: { __type: "String" },
    metaVideoDisabled: { __type: "Boolean" },
    opengraphDescription: { __type: "String" },
    opengraphImage: { __type: "MediaItem" },
    opengraphTitle: { __type: "String" },
    redirectionsEnabled: { __type: "Boolean" },
    redirectionsType: { __type: "String" },
    redirectionsURL: { __type: "String" },
    targetKeywords: { __type: "String" },
  ...
  SEOPressSettings: {
    __typename: { __type: "String!" },
    advanced: { __type: "SEOPressSettings_Advanced" },
    analytics: { __type: "SEOPressSettings_Analytics" },
    hasProLicense: { __type: "Boolean" },
    pro: { __type: "SEOPressSettings_Pro" },
    social: { __type: "SEOPressSettings_SocialNetworks" },
    titlesMetas: { __type: "SEOPressSettings_TitlesMetas" },
    tools: { __type: "SEOPressSettings_Tools" },
    xmlHtmlSitemap: { __type: "SEOPressSettings_XmlHtmlSitemap" },
  },
  SEOPressSettings_Advanced: {
    __typename: { __type: "String!" },
    addEditorToTaxonomy: { __type: "Boolean" },
    addSiteVerificationBing: { __type: "String" },
    addSiteVerificationGoogle: { __type: "String" },
    addSiteVerificationPinterest: { __type: "String" },
    addSiteVerificationYandex: { __type: "String" },
    automaticImageAltText: { __type: "Boolean" },
    automaticImageAltTextFromKeywords: { __type: "Boolean" },
    automaticImageCaption: { __type: "Boolean" },
    automaticImageDescription: { __type: "Boolean" },
    automaticImageTitle: { __type: "Boolean" },
    enableCanonicalUrlColumn: { __type: "Boolean" },
    enableContentAnalysisScoreColumn: { __type: "Boolean" },
    enableMetaDescriptionColumn: { __type: "Boolean" },
    enableNofollowColumn: { __type: "Boolean" },
    enableNoindexColumn: { __type: "Boolean" },
    enablePageSpeedColumn: { __type: "Boolean" },
    enableRedirectUrlColumn: { __type: "Boolean" },
    enableRedirectionEnableColumn: { __type: "Boolean" },
    enableTargetKeywordColumn: { __type: "Boolean" },
    enableTitleTagColumn: { __type: "Boolean" },
    enableTotalWordsColumn: { __type: "Boolean" },
    enableUniversalSeoMetabox: { __type: "Boolean" },
    metaboxSeoPosition: { __type: "String" },
    metaboxStructuredDataDefaultTab: { __type: "String" },
    permissionAdvancedPageSettings: {
      __type: "SEOPressSettings_AdvancedUserEnable",
    },
    ...
    permissionMetaboxSEO: { __type: "SEOPressSettings_AdvancedUserEnable" },
    ...
    redirectAttachmentPagesToFile: { __type: "Boolean" },
    redirectAttachmentPagesToParent: { __type: "Boolean" },
    removeAdviceStructuredDataMetabox: { __type: "Boolean" },
    removeCategoryInUrl: { __type: "Boolean" },
    removeCommentAuthorUrl: { __type: "Boolean" },
    removeCommentFormWebsiteInput: { __type: "Boolean" },
    removeContentAnalysisMetabox: { __type: "Boolean" },
    removeGeneratorMeta: { __type: "Boolean" },
    removeGenesisSeoFromAdminBar: { __type: "Boolean" },
    removeGenesisSeoMetabox: { __type: "Boolean" },
    removeHentryPostClass: { __type: "Boolean" },
    removeNoindexFromAdminBar: { __type: "Boolean" },
    removeNotificationCenter: { __type: "Boolean" },
    removeProductCategoryInUrl: { __type: "Boolean" },
    removeReallySimpleDiscoveryMeta: { __type: "Boolean" },
    removeReplytocom: { __type: "Boolean" },
    removeSeoAdminBar: { __type: "Boolean" },
    removeSeoNews: { __type: "Boolean" },
    removeSeoTools: { __type: "Boolean" },
    removeShortlinkMeta: { __type: "Boolean" },
    removeTrailingSlashMetas: { __type: "Boolean" },
    removeUniversalSeoMetabox: { __type: "Boolean" },
    removeWindowsLiveWriterMeta: { __type: "Boolean" },
  },
  SEOPressSettings_AdvancedUserEnable: {
    __typename: { __type: "String!" },
    administrator: { __type: "Boolean" },
    author: { __type: "Boolean" },
    contributor: { __type: "Boolean" },
    customer: { __type: "Boolean" },
    editor: { __type: "Boolean" },
    shop_manager: { __type: "Boolean" },
    subscriber: { __type: "Boolean" },
  },
  SEOPressSettings_Analytics: {
    __typename: { __type: "String!" },
    additionalTrackingBody: { __type: "String" },
    additionalTrackingFooter: { __type: "String" },
    additionalTrackingHead: { __type: "String" },
    cookieConsentAcceptButtonBackgroundColor: { __type: "String" },
    cookieConsentAcceptButtonBackgroundColorHover: { __type: "String" },
    cookieConsentAcceptButtonColor: { __type: "String" },
    cookieConsentAcceptButtonColorHover: { __type: "String" },
    cookieConsentAutomatic: { __type: "Boolean" },
    cookieConsentBackdropColor: { __type: "String" },
    cookieConsentBackdropCustomized: { __type: "Boolean" },
    cookieConsentBackgroundColor: { __type: "String" },
    cookieConsentBarWidth: { __type: "String" },
    cookieConsentChangeChoice: { __type: "Boolean" },
    cookieConsentCloseBackgroundColor: { __type: "String" },
    cookieConsentCloseBackgroundColorHover: { __type: "String" },
    cookieConsentCloseColor: { __type: "String" },
    cookieConsentCloseColorHover: { __type: "String" },
    cookieConsentCookieValidity: { __type: "Int" },
    cookieConsentLinkColor: { __type: "String" },
    cookieConsentOptOutClose: { __type: "String" },
    cookieConsentOptOutEdit: { __type: "String" },
    cookieConsentOptOutMessage: { __type: "String" },
    cookieConsentOptOutMessageOk: { __type: "String" },
    cookieConsentPosition: { __type: "String" },
    cookieConsentRequired: { __type: "Boolean" },
    cookieConsentTextAlign: { __type: "String" },
    cookieConsentTextColor: { __type: "String" },
    googleAnalyticsAdWords: { __type: "String" },
    googleAnalyticsAffiliateTracking: { __type: "String" },
    googleAnalyticsAffiliateTrackingEnable: { __type: "Boolean" },
    googleAnalyticsApiClientId: { __type: "String" },
    googleAnalyticsApiSecretId: { __type: "String" },
    googleAnalyticsCrossDomainList: { __type: "String" },
    googleAnalyticsCrossEnable: { __type: "Boolean" },
    googleAnalyticsCustomDimensionAuthor: { __type: "String" },
    googleAnalyticsCustomDimensionCategory: { __type: "String" },
    googleAnalyticsCustomDimensionLoggedIn: { __type: "String" },
    googleAnalyticsCustomDimensionPostType: { __type: "String" },
    googleAnalyticsCustomDimensionTag: { __type: "String" },
    googleAnalyticsDashboardWidget: { __type: "Boolean" },
    googleAnalyticsDownloadTracking: { __type: "String" },
    googleAnalyticsDownloadTrackingEnable: { __type: "Boolean" },
    googleAnalyticsEnable: { __type: "Boolean" },
    googleAnalyticsEventAddToCart: { __type: "Boolean" },
    googleAnalyticsEventPurchases: { __type: "Boolean" },
    googleAnalyticsEventRemoveFromCart: { __type: "Boolean" },
    googleAnalyticsGA4Code: { __type: "String" },
    googleAnalyticsHtmlLocation: { __type: "String" },
    googleAnalyticsIpAnonymization: { __type: "Boolean" },
    googleAnalyticsLinkAttribution: { __type: "Boolean" },
    googleAnalyticsLinkTrackingEnable: { __type: "Boolean" },
    googleAnalyticsNoTrackRoles: { __type: "SEOPressSettings_WhoToTrack" },
    googleAnalyticsOptimize: { __type: "String" },
    googleAnalyticsRemarketing: { __type: "Boolean" },
    googleAnalyticsUACode: { __type: "String" },
    matomoCrossDomainTracking: { __type: "Boolean" },
    matomoCrossDomainTrackingList: { __type: "String" },
    matomoEnable: { __type: "Boolean" },
    matomoHonorDoNotTrack: { __type: "Boolean" },
    matomoHost: { __type: "String" },
    matomoLinkDownloadTracking: { __type: "Boolean" },
    matomoNoCookies: { __type: "Boolean" },
    matomoNoHeatmaps: { __type: "Boolean" },
    matomoPrependDomain: { __type: "Boolean" },
    matomoSiteId: { __type: "String" },
    matomoSubdomainTracking: { __type: "Boolean" },
    matomoTrackWithoutJavascript: { __type: "Boolean" },
  },
  SEOPressSettings_ArchiveTitles: {
    __typename: { __type: "String!" },
    product: { __type: "SEOPressSettings_TitleDescriptionNoindexNofollow" },
  },
  SEOPressSettings_BreadcrumbCptList: {
    __typename: { __type: "String!" },
    category: { __type: "SEOPressSettings_BreadcrumbCptShow" },
    postTag: { __type: "SEOPressSettings_BreadcrumbCptShow" },
    productCategory: { __type: "SEOPressSettings_BreadcrumbCptShow" },
    productTag: { __type: "SEOPressSettings_BreadcrumbCptShow" },
  },
  SEOPressSettings_BreadcrumbCptShow: {
    __typename: { __type: "String!" },
    customPostType: { __type: "String" },
  },
  SEOPressSettings_BreadcrumbTaxonomiesList: {
    __typename: { __type: "String!" },
    page: { __type: "SEOPressSettings_BreadcrumbTaxonomiesShow" },
    post: { __type: "SEOPressSettings_BreadcrumbTaxonomiesShow" },
    product: { __type: "SEOPressSettings_BreadcrumbTaxonomiesShow" },
  },
  ...
  SEOPressSettings_BusinessDays: {
    __typename: { __type: "String!" },
    friday: { __type: "SEOPressSettings_OpenHoursAmPm" },
    monday: { __type: "SEOPressSettings_OpenHoursAmPm" },
    saturday: { __type: "SEOPressSettings_OpenHoursAmPm" },
    sunday: { __type: "SEOPressSettings_OpenHoursAmPm" },
    thursday: { __type: "SEOPressSettings_OpenHoursAmPm" },
    tuesday: { __type: "SEOPressSettings_OpenHoursAmPm" },
    wednesday: { __type: "SEOPressSettings_OpenHoursAmPm" },
  },
  SEOPressSettings_FacebookImgCustomPostTypes: {
    __typename: { __type: "String!" },
    product: { __type: "SEOPressSettings_FacebookImgDefault" },
  },
  ...
  SEOPressSettings_GoogleNewsPostTypes: {
    __typename: { __type: "String!" },
    actionMonitor: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    attachment: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    page: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    post: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    product: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    seopress404: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    seopressBot: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    seopressSchemas: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    shopCoupon: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    shopOrder: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
    wpBlock: { __type: "SEOPressSettings_GoogleNewsPostTypesEnabled" },
  },
  ...
  SEOPressSettings_OpenHours: {
    __typename: { __type: "String!" },
    end: { __type: "SEOPressSettings_Time" },
    open: { __type: "String" },
    start: { __type: "SEOPressSettings_Time" },
  },
  SEOPressSettings_OpenHoursAmPm: {
    __typename: { __type: "String!" },
    am: { __type: "SEOPressSettings_OpenHours" },
    closed: { __type: "Boolean" },
    pm: { __type: "SEOPressSettings_OpenHours" },
  },
  SEOPressSettings_PostTypesList: {
    __typename: { __type: "String!" },
    attachment: { __type: "SEOPressSettings_ShouldBeIncluded" },
    page: { __type: "SEOPressSettings_ShouldBeIncluded" },
    post: { __type: "SEOPressSettings_ShouldBeIncluded" },
    product: { __type: "SEOPressSettings_ShouldBeIncluded" },
  },
  SEOPressSettings_Pro: {
    __typename: { __type: "String!" },
    breadcrumbsEnabled: { __type: "Boolean" },
    breadcrumbsI18n404: { __type: "String" },
    breadcrumbsI18nAuthor: { __type: "String" },
    breadcrumbsI18nHere: { __type: "String" },
    breadcrumbsI18nHome: { __type: "String" },
    breadcrumbsI18nNoResults: { __type: "String" },
    breadcrumbsI18nSearch: { __type: "String" },
    breadcrumbsJsonEnabled: { __type: "Boolean" },
    breadcrumbsPostTypeShownCustomPostType: {
      __type: "SEOPressSettings_BreadcrumbCptList",
    },
    breadcrumbsPostTypeShownTaxonomy: {
      __type: "SEOPressSettings_BreadcrumbTaxonomiesList",
    },
    breadcrumbsRemoveDefaultSeparator: { __type: "Boolean" },
    breadcrumbsRemoveStaticPosts: { __type: "Boolean" },
    breadcrumbsRemoveStaticShopPage: { __type: "Boolean" },
    breadcrumbsSeparator: { __type: "String" },
    dublinCoreEnabled: { __type: "Boolean" },
    easyDigitalDownloadsAddProductPriceAmountMeta: { __type: "Boolean" },
    easyDigitalDownloadsAddProductPriceCurrencyMeta: { __type: "Boolean" },
    easyDigitalDownloadsRemoveGeneratorMeta: { __type: "Boolean" },
    googleNewsEnabled: { __type: "Boolean" },
    googleNewsName: { __type: "String" },
    googleNewsPostTypes: { __type: "SEOPressSettings_GoogleNewsPostTypes" },
    localBusinessCity: { __type: "String" },
    localBusinessCountry: { __type: "String" },
    localBusinessCuisine: { __type: "String" },
    localBusinessLatitude: { __type: "String" },
    localBusinessLongitude: { __type: "String" },
    localBusinessOpeningHours: { __type: "SEOPressSettings_BusinessDays" },
    localBusinessPhone: { __type: "String" },
    localBusinessPlaceId: { __type: "String" },
    localBusinessPostalCode: { __type: "String" },
    localBusinessPriceRange: { __type: "String" },
    localBusinessSchemaPage: { __type: "String" },
    localBusinessState: { __type: "String" },
    localBusinessStreetAddress: { __type: "String" },
    localBusinessType: { __type: "String" },
    localBusinessUrl: { __type: "String" },
    notFoundCleaningEnabled: { __type: "Boolean" },
    notFoundEmailNotificationAddress: { __type: "String" },
    notFoundEmailNotificationEnabled: { __type: "Boolean" },
    notFoundEmailNotificationNoAutomaticRedirect: { __type: "Boolean" },
    notFoundIpLogging: { __type: "String" },
    notFoundMonitoringEnabled: { __type: "Boolean" },
    notFoundRedirectTo: { __type: "String" },
    notFoundRedirectToCustomUrl: { __type: "String" },
    notFoundRedirectionStatusCode: { __type: "String" },
    rewriteSearchUrl: { __type: "String" },
    richSnippetsEnabled: { __type: "Boolean" },
    richSnippetsPublisherLogo: { __type: "String" },
    richSnippetsPublisherLogoHeight: { __type: "String" },
    richSnippetsPublisherLogoWidth: { __type: "String" },
    richSnippetsSiteNavigation: { __type: "String" },
    robotsFileContents: { __type: "String" },
    robotsFileEnabled: { __type: "Boolean" },
    rssAllDisabled: { __type: "Boolean" },
    rssCommentsDisabled: { __type: "Boolean" },
    rssExtraDisabled: { __type: "Boolean" },
    rssHtmlPrefix: { __type: "String" },
    rssHtmlSuffix: { __type: "String" },
    rssPostsDisabled: { __type: "Boolean" },
    whiteLabelFilterSeoDashiconsClass: { __type: "String" },
    whiteLabelRemoveAdminHeader: { __type: "Boolean" },
    whiteLabelRemoveCredits: { __type: "Boolean" },
    whiteLabelRemoveHeaderIcons: { __type: "Boolean" },
    whiteLabelRemoveHelpDocumentationIcons: { __type: "Boolean" },
    whiteLabelRemoveViewDetails: { __type: "Boolean" },
    whiteLabelSEOPressAdminBarImage: { __type: "String" },
    whiteLabelSEOPressAdminBarTitle: { __type: "String" },
    whiteLabelSEOPressAuthor: { __type: "String" },
    whiteLabelSEOPressDescription: { __type: "String" },
    whiteLabelSEOPressMainMenuTitle: { __type: "String" },
    whiteLabelSEOPressName: { __type: "String" },
    whiteLabelSEOPressProDescription: { __type: "String" },
    whiteLabelSEOPressProName: { __type: "String" },
    whiteLabelSEOPressWebsite: { __type: "String" },
    woocommerceAddProductPriceAmountMeta: { __type: "Boolean" },
    woocommerceAddProductPriceCurrencyMeta: { __type: "Boolean" },
    woocommerceNoindexAccountPage: { __type: "Boolean" },
    woocommerceNoindexCartPage: { __type: "Boolean" },
    woocommerceNoindexCheckoutPage: { __type: "Boolean" },
    woocommerceRemoveBreadcrumbsSchema: { __type: "Boolean" },
    woocommerceRemoveDefaultJsonLdSchema: { __type: "Boolean" },
    woocommerceRemoveGeneratorMeta: { __type: "Boolean" },
  },
  SEOPressSettings_ShouldBeIncluded: {
    __typename: { __type: "String!" },
    include: { __type: "Boolean" },
  },
  SEOPressSettings_SingleTitles: {
    __typename: { __type: "String!" },
    page: { __type: "SEOPressSettings_TitleDescriptionNoindex" },
    post: { __type: "SEOPressSettings_TitleDescriptionNoindex" },
    product: { __type: "SEOPressSettings_TitleDescriptionNoindex" },
  },
  SEOPressSettings_SocialNetworks: {
    __typename: { __type: "String!" },
    accountFacebook: { __type: "String" },
    accountInstagram: { __type: "String" },
    accountLinkedIn: { __type: "String" },
    accountPinterest: { __type: "String" },
    accountTwitter: { __type: "String" },
    accountYoutube: { __type: "String" },
    facebookAdminId: { __type: "String" },
    facebookAppId: { __type: "String" },
    facebookImg: { __type: "MediaItem" },
    facebookImgCustomPostTypes: {
      __type: "SEOPressSettings_FacebookImgCustomPostTypes",
    },
    facebookImgDefault: { __type: "Boolean" },
    facebookLinkOwnershipId: { __type: "String" },
    facebookOg: { __type: "Boolean" },
    knowledgeContactOption: { __type: "String" },
    knowledgeContactType: { __type: "String" },
    knowledgeImg: { __type: "MediaItem" },
    knowledgeName: { __type: "String" },
    knowledgePhone: { __type: "String" },
    knowledgeType: { __type: "String" },
    twitterCard: { __type: "Boolean" },
    twitterCardImg: { __type: "MediaItem" },
    twitterCardImgSize: { __type: "String" },
    twitterCardOg: { __type: "Boolean" },
  },
  SEOPressSettings_TaxTitles: {
    __typename: { __type: "String!" },
    category: {
      __type: "SEOPressSettings_TitleDescriptionNoindexNofollowDisable",
    },
    post_tag: {
      __type: "SEOPressSettings_TitleDescriptionNoindexNofollowDisable",
    },
  ...
  SEOPressSettings_TaxonomiesList: {
    __typename: { __type: "String!" },
    category: { __type: "SEOPressSettings_ShouldBeIncluded" },
    postTag: { __type: "SEOPressSettings_ShouldBeIncluded" },
    productCategory: { __type: "SEOPressSettings_ShouldBeIncluded" },
    productTag: { __type: "SEOPressSettings_ShouldBeIncluded" },
  },
  ...
  SEOPressSettings_TitleDescriptionNoindex: {
    ...
    date: { __type: "Boolean" },
    description: { __type: "String" },
    nofollow: { __type: "Boolean" },
    noindex: { __type: "Boolean" },
    thumb_gcs: { __type: "Boolean" },
    title: { __type: "String" },
  },
  ...
  SEOPressSettings_TitlesMetas: {
    __typename: { __type: "String!" },
    archive_titles: { __type: "SEOPressSettings_ArchiveTitles" },
    archives_404_desc: { __type: "String" },
    archives_404_title: { __type: "String" },
    archives_author_desc: { __type: "String" },
    archives_author_disable: { __type: "Boolean" },
    archives_author_noindex: { __type: "Boolean" },
    archives_author_title: { __type: "String" },
    archives_date_desc: { __type: "String" },
    archives_date_disable: { __type: "Boolean" },
    archives_date_noindex: { __type: "Boolean" },
    archives_date_title: { __type: "String" },
    archives_search_desc: { __type: "String" },
    archives_search_noindex: { __type: "Boolean" },
    archives_search_title: { __type: "String" },
    attachments_noindex: { __type: "Boolean" },
    home_site_desc: { __type: "String" },
    home_site_title: { __type: "String" },
    noarchive: { __type: "Boolean" },
    nofollow: { __type: "Boolean" },
    noimageindex: { __type: "Boolean" },
    noindex: { __type: "Boolean" },
    noodp: { __type: "Boolean" },
    nositelinkssearchbox: { __type: "Boolean" },
    nosnippet: { __type: "Boolean" },
    paged_noindex: { __type: "Boolean" },
    paged_rel: { __type: "Boolean" },
    separator: { __type: "String" },
    single_titles: { __type: "SEOPressSettings_SingleTitles" },
    tax_titles: { __type: "SEOPressSettings_TaxTitles" },
  },
  SEOPressSettings_Tools: {
    __typename: { __type: "String!" },
    compatibilityAviaLayout: { __type: "Boolean" },
    compatibilityDivi: { __type: "Boolean" },
    compatibilityFusion: { __type: "Boolean" },
    compatibilityOxygen: { __type: "Boolean" },
    compatibilityWpBakery: { __type: "Boolean" },
  },
  ...
  SEOPressSettings_XmlHtmlSitemap: {
    __typename: { __type: "String!" },
    htmlArchiveLinks: { __type: "Boolean" },
    htmlDate: { __type: "Boolean" },
    htmlExclude: { __type: "String" },
    htmlMapping: { __type: "String" },
    htmlOrder: { __type: "String" },
    htmlOrderby: { __type: "String" },
    sitemapPostTypes: { __type: "SEOPressSettings_PostTypesList" },
    sitemapTaxonomies: { __type: "SEOPressSettings_TaxonomiesList" },
    xmlSitemapAuthorEnabled: { __type: "Boolean" },
    xmlSitemapGeneralEnabled: { __type: "Boolean" },
    xmlSitemapHTMLEnabled: { __type: "Boolean" },
    xmlSitemapImageEnabled: { __type: "Boolean" },
    xmlSitemapVideoEnabled: { __type: "Boolean" },
  },
  ...
  query: {
    ...
    seoPressSettings: { __type: "SEOPressSettings" },
  ...
  [SchemaUnionsKey]: {
    ...
    ContentNode: ["MediaItem", "Page", "Post", "TeamMember"],
    HierarchicalContentNode: ["MediaItem", "Page"],
    NodeWithAuthor: ["MediaItem", "Page", "Post", "TeamMember"],
    NodeWithComments: ["MediaItem", "Page", "Post"],
    NodeWithTemplate: ["MediaItem", "Page", "Post", "TeamMember"],
...
export interface Category {
  ...
  /**
   * The SEOPress data of the Categories taxonomy.
   */
  seo?: Maybe<SEOPress>;
  /**
...
export interface ContentNode {
  __typename?: "MediaItem" | "Page" | "Post" | "TeamMember";
  conditionalTags?: Maybe<ConditionalTags>;
  /**
...
export interface MediaItem {
  ...
  previewRevisionId?: Maybe<ScalarsEnums["ID"]>;
  /**
   * The SEOPress data of the mediaItem
   */
  seo?: Maybe<SEOPress>;
  /**
...
export interface PostFormat {
  ...
  /**
   * The SEOPress data of the Formats taxonomy.
   */
  seo?: Maybe<SEOPress>;
  /**
   * An alphanumeric identifier for the object unique to its type.
...
/**
 * The SEOPress schema data
 */
export interface SEOPress {
  __typename?: "SEOPress";
  /**
  ...
  /**
   * Whether or not the site has a pro license.
   */
  hasProLicense?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The preferred description for the page.
   */
  metaDesc?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should robots skip indexing this news.
   */
  metaNewsDisabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should meta robot tag `noarchive` be included
   */
  metaRobotsArchive?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Custom breadcrumbs.
   */
  metaRobotsBreadcrumbs?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should meta robot tag `noimageindex` be included
   */
  metaRobotsImageIndex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should robots skip following linked pages.
   */
  metaRobotsNofollow?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should robots skip indexing this page.
   */
  metaRobotsNoindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should meta robot tag `noodp` be included
   */
  metaRobotsOdp?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The primary category ID, returns `0` if no category.
   */
  metaRobotsPrimaryCategory?: Maybe<ScalarsEnums["Int"]>;
  /**
   * Should meta robot tag `nosnippet` be included
   */
  metaRobotsSnippet?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The preferred title for the page.
   */
  metaTitle?: Maybe<ScalarsEnums["String"]>;
  /**
   * Array of Videos.
   */
  metaVideo?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should robots skip indexing this video.
   */
  metaVideoDisabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The preferred OpenGraph description for the page.
   */
  opengraphDescription?: Maybe<ScalarsEnums["String"]>;
  /**
   * The preferred OpenGraph image for the page.
   */
  opengraphImage?: Maybe<MediaItem>;
  /**
   * The preferred OpenGraph title for the page.
   */
  opengraphTitle?: Maybe<ScalarsEnums["String"]>;
  /**
   * Does a redirection exist for this.
   */
  redirectionsEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The type HTTP status code of the redirection.
   */
  redirectionsType?: Maybe<ScalarsEnums["String"]>;
  /**
   * The URL that redirects here.
   */
  redirectionsURL?: Maybe<ScalarsEnums["String"]>;
  /**
   * Target keywords separated by commas.
   */
  targetKeywords?: Maybe<ScalarsEnums["String"]>;
  /**
   * The preferred Twitter description for the page.
   */
  twitterDescription?: Maybe<ScalarsEnums["String"]>;
  /**
   * The preferred Twitter image for the page.
   */
  twitterImage?: Maybe<MediaItem>;
  /**
   * The preferred Twitter title for the page.
   */
  twitterTitle?: Maybe<ScalarsEnums["String"]>;
}

/**
 * All SEOPress admin settings pages.
 */
export interface SEOPressSettings {
  __typename?: "SEOPressSettings";
  advanced?: Maybe<SEOPressSettings_Advanced>;
  analytics?: Maybe<SEOPressSettings_Analytics>;
  /**
   * Does the site have an SEOPress Pro license
   */
  hasProLicense?: Maybe<ScalarsEnums["Boolean"]>;
  pro?: Maybe<SEOPressSettings_Pro>;
  social?: Maybe<SEOPressSettings_SocialNetworks>;
  titlesMetas?: Maybe<SEOPressSettings_TitlesMetas>;
  tools?: Maybe<SEOPressSettings_Tools>;
  xmlHtmlSitemap?: Maybe<SEOPressSettings_XmlHtmlSitemap>;
}

/**
 * SEOPress Advanced settings pages.
 */
export interface SEOPressSettings_Advanced {
  __typename?: "SEOPressSettings_Advanced";
  /**
   * Add WP Editor to taxonomy description textarea
   */
  addEditorToTaxonomy?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Bing site verification string
   */
  addSiteVerificationBing?: Maybe<ScalarsEnums["String"]>;
  /**
   * Google site verification string
   */
  addSiteVerificationGoogle?: Maybe<ScalarsEnums["String"]>;
  /**
   * Pinterest site verification string
   */
  addSiteVerificationPinterest?: Maybe<ScalarsEnums["String"]>;
  /**
   * Yandex site verification string
   */
  addSiteVerificationYandex?: Maybe<ScalarsEnums["String"]>;
  /**
   * Automatically set the image Alt text
   */
  automaticImageAltText?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Automatically set the image Alt text from target keywords
   */
  automaticImageAltTextFromKeywords?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Automatically set the image Caption
   */
  automaticImageCaption?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Automatically set the image Description
   */
  automaticImageDescription?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Automatically set the image Title
   */
  automaticImageTitle?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show canonical URL column in post types
   */
  enableCanonicalUrlColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show content analysis score column in post types
   */
  enableContentAnalysisScoreColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show Meta description column in post types
   */
  enableMetaDescriptionColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show nofollow column in post types
   */
  enableNofollowColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show noindex column in post types
   */
  enableNoindexColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show Google Page Speed column in post types
   */
  enablePageSpeedColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show Redirect URL column in post types
   */
  enableRedirectUrlColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show Redirection Enable column in post types
   */
  enableRedirectionEnableColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show Target Keyword column in post types
   */
  enableTargetKeywordColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show Title tag column in post types
   */
  enableTitleTagColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Show total number of words column in post types
   */
  enableTotalWordsColumn?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Universal Metabox (Gutenberg)
   */
  enableUniversalSeoMetabox?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * SEO metabox&#039;s position
   */
  metaboxSeoPosition?: Maybe<ScalarsEnums["String"]>;
  /**
   * Default tab for Structured data metabox
   */
  metaboxStructuredDataDefaultTab?: Maybe<ScalarsEnums["String"]>;
  /**
   * Which user roles are allowed to access Advanced settings page.
   */
  permissionAdvancedPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access Analytics settings page.
   */
  permissionAnalyticsPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access BOT settings page.
   */
  permissionBotPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Block access to Content Analysis metaboxes in editor.
   */
  permissionMetaboxContentAnalysis?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Block access to SEO metaboxes in editor.
   */
  permissionMetaboxSEO?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access PRO settings page.
   */
  permissionProPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access Social Networks settings page.
   */
  permissionSocialNetworksPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Block access to Structured Data Types metaboxes in editor.
   */
  permissionStructuredDataTypesMetabox?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access Titles &amp; Metas settings page.
   */
  permissionTitlesMetasPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access Tools settings page.
   */
  permissionToolsPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Which user roles are allowed to access XML - HTML Sitemap settings page.
   */
  permissionXmlHtmlSitemapPageSettings?: Maybe<SEOPressSettings_AdvancedUserEnable>;
  /**
   * Redirect attachment pages to their file URL
   */
  redirectAttachmentPagesToFile?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Redirect attachment pages to post parent
   */
  redirectAttachmentPagesToParent?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide advice in Structured Data Types metabox
   */
  removeAdviceStructuredDataMetabox?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove `/category/` in URL
   */
  removeCategoryInUrl?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove author URL
   */
  removeCommentAuthorUrl?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove website field in comment form
   */
  removeCommentFormWebsiteInput?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove Content Analysis Metabox
   */
  removeContentAnalysisMetabox?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove WordPress generator meta tag
   */
  removeGeneratorMeta?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide Genesis SEO Settings link
   */
  removeGenesisSeoFromAdminBar?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide Genesis SEO Metabox
   */
  removeGenesisSeoMetabox?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove hentry post class
   */
  removeHentryPostClass?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noindex in admin bar
   */
  removeNoindexFromAdminBar?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide Notifications Center
   */
  removeNotificationCenter?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove `/product-category/` in URL
   */
  removeProductCategoryInUrl?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove RSD meta tag
   */
  removeReallySimpleDiscoveryMeta?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove ?replytocom link to avoid duplicate content
   */
  removeReplytocom?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * SEO in admin bar
   */
  removeSeoAdminBar?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide SEO News in SEO Dashboard Page
   */
  removeSeoNews?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide SEO tools in SEO Dashboard Page
   */
  removeSeoTools?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove WordPress shortlink meta tag
   */
  removeShortlinkMeta?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable trailing slash for metas
   */
  removeTrailingSlashMetas?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable Universal Metabox
   */
  removeUniversalSeoMetabox?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove Windows Live Writer meta tag
   */
  removeWindowsLiveWriterMeta?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Set Permissions Options for Users
 */
export interface SEOPressSettings_AdvancedUserEnable {
  __typename?: "SEOPressSettings_AdvancedUserEnable";
  /**
   * True if enabled.
   */
  administrator?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * True if enabled.
   */
  author?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * True if enabled.
   */
  contributor?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * True if enabled.
   */
  customer?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * True if enabled.
   */
  editor?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * True if enabled.
   */
  shop_manager?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * True if enabled.
   */
  subscriber?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * SEOPress Analytics settings pages.
 */
export interface SEOPressSettings_Analytics {
  __typename?: "SEOPressSettings_Analytics";
  /**
   * Additional tracking code to add to top of body.
   */
  additionalTrackingBody?: Maybe<ScalarsEnums["String"]>;
  /**
   * Additional tracking code to add to bottom of body.
   */
  additionalTrackingFooter?: Maybe<ScalarsEnums["String"]>;
  /**
   * Additional tracking code to add to head.
   */
  additionalTrackingHead?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar accept button background color.
   */
  cookieConsentAcceptButtonBackgroundColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar accept button background (:hover) color.
   */
  cookieConsentAcceptButtonBackgroundColorHover?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar accept button text color.
   */
  cookieConsentAcceptButtonColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar accept button text (:hover) color.
   */
  cookieConsentAcceptButtonColorHover?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should site automatically accept user&#039;s consent for analytics tracking.
   */
  cookieConsentAutomatic?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Cookie consent bar backdrop color.
   */
  cookieConsentBackdropColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Customized cookie consent bar backdrop.
   */
  cookieConsentBackdropCustomized?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Cookie consent bar background color.
   */
  cookieConsentBackgroundColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * How wide the cookie bar should be. (Can return any CSS measurement)
   */
  cookieConsentBarWidth?: Maybe<ScalarsEnums["String"]>;
  /**
   * Allow user to change its choice about cookies
   */
  cookieConsentChangeChoice?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Cookie consent bar close button background color.
   */
  cookieConsentCloseBackgroundColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar close button background (:hover) color.
   */
  cookieConsentCloseBackgroundColorHover?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar close button text color.
   */
  cookieConsentCloseColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar close button text (:hover) color.
   */
  cookieConsentCloseColorHover?: Maybe<ScalarsEnums["String"]>;
  /**
   * User consent cookie expiration date.
   */
  cookieConsentCookieValidity?: Maybe<ScalarsEnums["Int"]>;
  /**
   * Cookie consent bar link color.
   */
  cookieConsentLinkColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Button text to close banner.
   */
  cookieConsentOptOutClose?: Maybe<ScalarsEnums["String"]>;
  /**
   * Button text to edit tracking preferences.
   */
  cookieConsentOptOutEdit?: Maybe<ScalarsEnums["String"]>;
  /**
   * Consent message for user tracking.
   */
  cookieConsentOptOutMessage?: Maybe<ScalarsEnums["String"]>;
  /**
   * Button text to accept tracking.
   */
  cookieConsentOptOutMessageOk?: Maybe<ScalarsEnums["String"]>;
  /**
   * Where on the page to place the cookie banner.
   */
  cookieConsentPosition?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should site request user&#039;s consent for analytics tracking.
   */
  cookieConsentRequired?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * How to align text in the cookie banner.
   */
  cookieConsentTextAlign?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cookie consent bar text color.
   */
  cookieConsentTextColor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Google AdWords ID.
   */
  googleAnalyticsAdWords?: Maybe<ScalarsEnums["String"]>;
  /**
   * Keywords for affiliate link tracking to send to Google Analytics.
   */
  googleAnalyticsAffiliateTracking?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should affiliate link tracking be sent to Google Analytics.
   */
  googleAnalyticsAffiliateTrackingEnable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Google Analytics API client ID. (Ref: https://www.seopress.org/support/guides/connect-wordpress-site-google-analytics/)
   */
  googleAnalyticsApiClientId?: Maybe<ScalarsEnums["String"]>;
  /**
   * Google Analytics API secret ID. (Ref: https://www.seopress.org/support/guides/connect-wordpress-site-google-analytics/)
   */
  googleAnalyticsApiSecretId?: Maybe<ScalarsEnums["String"]>;
  /**
   * Other domains to register for cross-domain tracking in Google Analytics.
   */
  googleAnalyticsCrossDomainList?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable cross-domain tracking in Google Analytics.
   */
  googleAnalyticsCrossEnable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Custom dimension for author pages.
   */
  googleAnalyticsCustomDimensionAuthor?: Maybe<ScalarsEnums["String"]>;
  /**
   * Custom dimension for category pages.
   */
  googleAnalyticsCustomDimensionCategory?: Maybe<ScalarsEnums["String"]>;
  /**
   * Custom dimension for logged in users.
   */
  googleAnalyticsCustomDimensionLoggedIn?: Maybe<ScalarsEnums["String"]>;
  /**
   * Custom dimension for post type pages.
   */
  googleAnalyticsCustomDimensionPostType?: Maybe<ScalarsEnums["String"]>;
  /**
   * Custom dimension for tag pages.
   */
  googleAnalyticsCustomDimensionTag?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should Google Analytics dashboard widget be removed.
   */
  googleAnalyticsDashboardWidget?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * File types to track downloads of in Google Analytics.
   */
  googleAnalyticsDownloadTracking?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should download tracking be sent to Google Analytics.
   */
  googleAnalyticsDownloadTrackingEnable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Enable Google Analytics.
   */
  googleAnalyticsEnable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should &quot;Add to cart events&quot; be tracked in Google Analytics.
   */
  googleAnalyticsEventAddToCart?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should purchases be tracked in Google Analytics.
   */
  googleAnalyticsEventPurchases?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should &quot;Remove from cart events&quot; be tracked in Google Analytics.
   */
  googleAnalyticsEventRemoveFromCart?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Google Analytics 4 measurement ID.
   */
  googleAnalyticsGA4Code?: Maybe<ScalarsEnums["String"]>;
  /**
   * Where in the page to put the Google Analytics tracking code.
   */
  googleAnalyticsHtmlLocation?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable IP Anonymization in Google Analytics.
   */
  googleAnalyticsIpAnonymization?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Enhanced Link Attribution in Google Analytics
   */
  googleAnalyticsLinkAttribution?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Should external link tracking be sent to Google Analytics.
   */
  googleAnalyticsLinkTrackingEnable?: Maybe<ScalarsEnums["Boolean"]>;
  googleAnalyticsNoTrackRoles?: Maybe<SEOPressSettings_WhoToTrack>;
  /**
   * Google Analytics Optimize ID.
   */
  googleAnalyticsOptimize?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable remarketing, demographics, and interests reporting in Google Analytics.
   */
  googleAnalyticsRemarketing?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Google Analytics Universal Analytics tracking ID.
   */
  googleAnalyticsUACode?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable cross domain tracking in Matomo.
   */
  matomoCrossDomainTracking?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Cross domain tracking site list for Matomo.
   */
  matomoCrossDomainTrackingList?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable Matomo
   */
  matomoEnable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Enable DoNotTrack detection in Matomo.
   */
  matomoHonorDoNotTrack?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Matomo host.
   */
  matomoHost?: Maybe<ScalarsEnums["String"]>;
  /**
   * Download &amp; Outlink tracking in Matomo.
   */
  matomoLinkDownloadTracking?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable all tracking cookies in Matomo
   */
  matomoNoCookies?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable all heatmaps and session recordings in Matomo.
   */
  matomoNoHeatmaps?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Prepend the site domain to the page title when tracking in Matomo.
   */
  matomoPrependDomain?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Matomo site ID.
   */
  matomoSiteId?: Maybe<ScalarsEnums["String"]>;
  /**
   * Track visitors across all subdomains in Matomo.
   */
  matomoSubdomainTracking?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Track users with JavaScript disabled in Matomo.
   */
  matomoTrackWithoutJavascript?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Title and description format and whether should be marked as noindex for categories and taxonomies.
 */
export interface SEOPressSettings_ArchiveTitles {
  __typename?: "SEOPressSettings_ArchiveTitles";
  product?: Maybe<SEOPressSettings_TitleDescriptionNoindexNofollow>;
}

/**
 * Which custom post types to show in breadcrumbs.
 */
export interface SEOPressSettings_BreadcrumbCptList {
  __typename?: "SEOPressSettings_BreadcrumbCptList";
  category?: Maybe<SEOPressSettings_BreadcrumbCptShow>;
  postTag?: Maybe<SEOPressSettings_BreadcrumbCptShow>;
  productCategory?: Maybe<SEOPressSettings_BreadcrumbCptShow>;
  productTag?: Maybe<SEOPressSettings_BreadcrumbCptShow>;
}

/**
 * Custom post type to show.
 */
export interface SEOPressSettings_BreadcrumbCptShow {
  __typename?: "SEOPressSettings_BreadcrumbCptShow";
  /**
   * The custom post type to show in breadcrumbs.
   */
  customPostType?: Maybe<ScalarsEnums["String"]>;
}

/**
 * Which custom taxonomy to show in breadcrumbs.
 */
export interface SEOPressSettings_BreadcrumbTaxonomiesList {
  __typename?: "SEOPressSettings_BreadcrumbTaxonomiesList";
  page?: Maybe<SEOPressSettings_BreadcrumbTaxonomiesShow>;
  post?: Maybe<SEOPressSettings_BreadcrumbTaxonomiesShow>;
  product?: Maybe<SEOPressSettings_BreadcrumbTaxonomiesShow>;
}

/**
 * Taxonomy to show.
 */
export interface SEOPressSettings_BreadcrumbTaxonomiesShow {
  __typename?: "SEOPressSettings_BreadcrumbTaxonomiesShow";
  /**
   * The custom post type to show in breadcrumbs.
   */
  taxonomy?: Maybe<ScalarsEnums["String"]>;
}

/**
 * List of days.
 */
export interface SEOPressSettings_BusinessDays {
  __typename?: "SEOPressSettings_BusinessDays";
  /**
   * Hours open on Friday.
   */
  friday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
  /**
   * Hours open on Monday.
   */
  monday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
  /**
   * Hours open on Saturday.
   */
  saturday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
  /**
   * Hours open on Sunday.
   */
  sunday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
  /**
   * Hours open on Thursday.
   */
  thursday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
  /**
   * Hours open on Tuesday.
   */
  tuesday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
  /**
   * Hours open on Wednesday.
   */
  wednesday?: Maybe<SEOPressSettings_OpenHoursAmPm>;
}

/**
 * SEOPress Custom Post Type Default Facebook Images.
 */
export interface SEOPressSettings_FacebookImgCustomPostTypes {
  __typename?: "SEOPressSettings_FacebookImgCustomPostTypes";
  /**
   * Default image for the custom post type: `product`.
   */
  product?: Maybe<SEOPressSettings_FacebookImgDefault>;
}

/**
 * SEOPress Custom Post Type Default Facebook Images.
 */
export interface SEOPressSettings_FacebookImgDefault {
  __typename?: "SEOPressSettings_FacebookImgDefault";
  /**
   * Default image url
   */
  url?: Maybe<ScalarsEnums["String"]>;
 ...
 */
export interface SEOPressSettings_GoogleNewsPostTypes {
  __typename?: "SEOPressSettings_GoogleNewsPostTypes";
  actionMonitor?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  attachment?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  page?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  post?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  product?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  seopress404?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  seopressBot?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  seopressSchemas?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  shopCoupon?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  shopOrder?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
  wpBlock?: Maybe<SEOPressSettings_GoogleNewsPostTypesEnabled>;
}

/**
 * Is this enabled
 */
export interface SEOPressSettings_GoogleNewsPostTypesEnabled {
  __typename?: "SEOPressSettings_GoogleNewsPostTypesEnabled";
  enabled?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Is business open, and start and end times.
 */
export interface SEOPressSettings_OpenHours {
  __typename?: "SEOPressSettings_OpenHours";
  /**
   * End time of open hours.
   */
  end?: Maybe<SEOPressSettings_Time>;
  /**
   * The business is open.
   */
  open?: Maybe<ScalarsEnums["String"]>;
  /**
   * Start time of open hours.
   */
  start?: Maybe<SEOPressSettings_Time>;
}

/**
 * Is business closed all day and when open.
 */
export interface SEOPressSettings_OpenHoursAmPm {
  __typename?: "SEOPressSettings_OpenHoursAmPm";
  /**
   * Hours open on Monday.
   */
  am?: Maybe<SEOPressSettings_OpenHours>;
  /**
   * The business is closed on this day.
   */
  closed?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hours open on Tuesday.
   */
  pm?: Maybe<SEOPressSettings_OpenHours>;
}

/**
 * Title and Description Format.
 */
export interface SEOPressSettings_PostTypesList {
  __typename?: "SEOPressSettings_PostTypesList";
  attachment?: Maybe<SEOPressSettings_ShouldBeIncluded>;
  page?: Maybe<SEOPressSettings_ShouldBeIncluded>;
  post?: Maybe<SEOPressSettings_ShouldBeIncluded>;
  product?: Maybe<SEOPressSettings_ShouldBeIncluded>;
}

/**
 * SEOPress Tools settings pages.
 */
export interface SEOPressSettings_Pro {
  __typename?: "SEOPressSettings_Pro";
  breadcrumbsEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Translation for &quot;Error 404&quot;.
   */
  breadcrumbsI18n404?: Maybe<ScalarsEnums["String"]>;
  /**
   * Translation for &quot;Author:&quot;.
   */
  breadcrumbsI18nAuthor?: Maybe<ScalarsEnums["String"]>;
  /**
   * HTML prefixing breadcrumbs.
   */
  breadcrumbsI18nHere?: Maybe<ScalarsEnums["String"]>;
  /**
   * Translation for &quot;Homepage&quot;.
   */
  breadcrumbsI18nHome?: Maybe<ScalarsEnums["String"]>;
  /**
   * Translation for &quot;No results&quot;.
   */
  breadcrumbsI18nNoResults?: Maybe<ScalarsEnums["String"]>;
  /**
   * Translation for &quot;Search results for&quot;.
   */
  breadcrumbsI18nSearch?: Maybe<ScalarsEnums["String"]>;
  breadcrumbsJsonEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Post type to show in Breadcrumbs for custom post types.
   */
  breadcrumbsPostTypeShownCustomPostType?: Maybe<SEOPressSettings_BreadcrumbCptList>;
  /**
   * Post type to show in Breadcrumbs for taxonomies.
   */
  breadcrumbsPostTypeShownTaxonomy?: Maybe<SEOPressSettings_BreadcrumbTaxonomiesList>;
  breadcrumbsRemoveDefaultSeparator?: Maybe<ScalarsEnums["Boolean"]>;
  breadcrumbsRemoveStaticPosts?: Maybe<ScalarsEnums["Boolean"]>;
  breadcrumbsRemoveStaticShopPage?: Maybe<ScalarsEnums["Boolean"]>;
  breadcrumbsSeparator?: Maybe<ScalarsEnums["String"]>;
  /**
   * Dublin Core meta tags enabled.
   */
  dublinCoreEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  easyDigitalDownloadsAddProductPriceAmountMeta?: Maybe<
    ScalarsEnums["Boolean"]
  >;
  easyDigitalDownloadsAddProductPriceCurrencyMeta?: Maybe<
    ScalarsEnums["Boolean"]
  >;
  easyDigitalDownloadsRemoveGeneratorMeta?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is the Google News sitemap enabled.
   */
  googleNewsEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The Google News publisher name.
   */
  googleNewsName?: Maybe<ScalarsEnums["String"]>;
  /**
   * The list of post types that will be shown in Google News sitemap.
   */
  googleNewsPostTypes?: Maybe<SEOPressSettings_GoogleNewsPostTypes>;
  /**
   * City to use in local business schema.
   */
  localBusinessCity?: Maybe<ScalarsEnums["String"]>;
  /**
   * Country to use in local business schema.
   */
  localBusinessCountry?: Maybe<ScalarsEnums["String"]>;
  /**
   * Cuisine to use in local business schema.
   */
  localBusinessCuisine?: Maybe<ScalarsEnums["String"]>;
  /**
   * Latitude to use in local business schema.
   */
  localBusinessLatitude?: Maybe<ScalarsEnums["String"]>;
  /**
   * Longitude to use in local business schema.
   */
  localBusinessLongitude?: Maybe<ScalarsEnums["String"]>;
  /**
   * Open Hours to use in local business schema.
   */
  localBusinessOpeningHours?: Maybe<SEOPressSettings_BusinessDays>;
  /**
   * Phone to use in local business schema.
   */
  localBusinessPhone?: Maybe<ScalarsEnums["String"]>;
  /**
   * Place ID to use in local business schema. (Ref: https://developers.google.com/places/web-service/place-id)
   */
  localBusinessPlaceId?: Maybe<ScalarsEnums["String"]>;
  /**
   * Postal code to use in local business schema.
   */
  localBusinessPostalCode?: Maybe<ScalarsEnums["String"]>;
  /**
   * Price range to use in local business schema.
   */
  localBusinessPriceRange?: Maybe<ScalarsEnums["String"]>;
  /**
   * Which page to display schema on.
   */
  localBusinessSchemaPage?: Maybe<ScalarsEnums["String"]>;
  /**
   * State to use in local business schema.
   */
  localBusinessState?: Maybe<ScalarsEnums["String"]>;
  /**
   * Street address to use in local business schema.
   */
  localBusinessStreetAddress?: Maybe<ScalarsEnums["String"]>;
  /**
   * What type of local business schema type to use.
   */
  localBusinessType?: Maybe<ScalarsEnums["String"]>;
  /**
   * URL to use in local business schema.
   */
  localBusinessUrl?: Maybe<ScalarsEnums["String"]>;
  /**
   * Automatically delete 404 after 30 days (useful if you have a lot of 404).
   */
  notFoundCleaningEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The address for email notification of a new 404.
   */
  notFoundEmailNotificationAddress?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should emails be sent when a new 404 is created.
   */
  notFoundEmailNotificationEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable email for automatic redirections (if post URL changed).
   */
  notFoundEmailNotificationNoAutomaticRedirect?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * How much of the IP should be logged when user hits a 404 (none, full, anon).
   */
  notFoundIpLogging?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable 404 monitoring
   */
  notFoundMonitoringEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Where to redirect 404s to (custom, home, or none).
   */
  notFoundRedirectTo?: Maybe<ScalarsEnums["String"]>;
  /**
   * URL to redirect to in case of 404.
   */
  notFoundRedirectToCustomUrl?: Maybe<ScalarsEnums["String"]>;
  /**
   * The HTTP status code to use on redirecting a 404.
   */
  notFoundRedirectionStatusCode?: Maybe<ScalarsEnums["String"]>;
  /**
   * The custom URL for the search page.
   */
  rewriteSearchUrl?: Maybe<ScalarsEnums["String"]>;
  richSnippetsEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  richSnippetsPublisherLogo?: Maybe<ScalarsEnums["String"]>;
  richSnippetsPublisherLogoHeight?: Maybe<ScalarsEnums["String"]>;
  richSnippetsPublisherLogoWidth?: Maybe<ScalarsEnums["String"]>;
  richSnippetsSiteNavigation?: Maybe<ScalarsEnums["String"]>;
  /**
   * The contents of the `robots.txt` file that is controlled by SEOPress.
   */
  robotsFileContents?: Maybe<ScalarsEnums["String"]>;
  /**
   * Is the robots file enabled in SEOPress.
   */
  robotsFileEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable all RSS feeds.
   */
  rssAllDisabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove link to comments RSS feed.
   */
  rssCommentsDisabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove link to extra RSS feed (used for: author, categories, custom taxonomies, custom post type, comments feed for a single post...).
   */
  rssExtraDisabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * HTML before each post in RSS feed.
   */
  rssHtmlPrefix?: Maybe<ScalarsEnums["String"]>;
  /**
   * HTML after each post in RSS feed.
   */
  rssHtmlSuffix?: Maybe<ScalarsEnums["String"]>;
  /**
   * Remove link to posts RSS feed.
   */
  rssPostsDisabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Custom CSS class for Dashicons.
   */
  whiteLabelFilterSeoDashiconsClass?: Maybe<ScalarsEnums["String"]>;
  /**
   * Remove the SEOPress admin header including Notifications Center, SEO tools and Useful links.
   */
  whiteLabelRemoveAdminHeader?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is the footer credits to SEOPress removed.
   */
  whiteLabelRemoveCredits?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove SEOPress icons on the right in header (changelog, YouTube, Twitter...)
   */
  whiteLabelRemoveHeaderIcons?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Hide SEOPress link/help icons.
   */
  whiteLabelRemoveHelpDocumentationIcons?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Remove the &quot;View Details&quot; button in the plugin list.
   */
  whiteLabelRemoveViewDetails?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The URL to the whitelabel image.
   */
  whiteLabelSEOPressAdminBarImage?: Maybe<ScalarsEnums["String"]>;
  /**
   * The title to display for SEOPress in the top admin bar.
   */
  whiteLabelSEOPressAdminBarTitle?: Maybe<ScalarsEnums["String"]>;
  /**
   * The author for SEOPress to display with in the plugin list.
   */
  whiteLabelSEOPressAuthor?: Maybe<ScalarsEnums["String"]>;
  /**
   * The description for SEOPress to display with in the plugin list.
   */
  whiteLabelSEOPressDescription?: Maybe<ScalarsEnums["String"]>;
  /**
   * The title to display for SEOPress in the dashboard sidebar.
   */
  whiteLabelSEOPressMainMenuTitle?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name for SEOPress to display as in the plugin list.
   */
  whiteLabelSEOPressName?: Maybe<ScalarsEnums["String"]>;
  /**
   * The description for SEOPress Pro to display with in the plugin list.
   */
  whiteLabelSEOPressProDescription?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name for SEOPress Pro to display as in the plugin list.
   */
  whiteLabelSEOPressProName?: Maybe<ScalarsEnums["String"]>;
  /**
   * The author URL for SEOPress to display with in the plugin list.
   */
  whiteLabelSEOPressWebsite?: Maybe<ScalarsEnums["String"]>;
  woocommerceAddProductPriceAmountMeta?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceAddProductPriceCurrencyMeta?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceNoindexAccountPage?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceNoindexCartPage?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceNoindexCheckoutPage?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceRemoveBreadcrumbsSchema?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceRemoveDefaultJsonLdSchema?: Maybe<ScalarsEnums["Boolean"]>;
  woocommerceRemoveGeneratorMeta?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Title and Description Format.
 */
export interface SEOPressSettings_ShouldBeIncluded {
  __typename?: "SEOPressSettings_ShouldBeIncluded";
  /**
   * Should this be included in the sitemap?
   */
  include?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Title and description format for posts and pages.
 */
export interface SEOPressSettings_SingleTitles {
  __typename?: "SEOPressSettings_SingleTitles";
  page?: Maybe<SEOPressSettings_TitleDescriptionNoindex>;
  post?: Maybe<SEOPressSettings_TitleDescriptionNoindex>;
  product?: Maybe<SEOPressSettings_TitleDescriptionNoindex>;
}

/**
 * SEOPress Social Networks settings pages.
 */
export interface SEOPressSettings_SocialNetworks {
  __typename?: "SEOPressSettings_SocialNetworks";
  /**
   * Facebook Page URL.
   */
  accountFacebook?: Maybe<ScalarsEnums["String"]>;
  /**
   * Instagram Page URL.
   */
  accountInstagram?: Maybe<ScalarsEnums["String"]>;
  /**
   * LinkedIn Page URL.
   */
  accountLinkedIn?: Maybe<ScalarsEnums["String"]>;
  /**
   * Pinterest Page URL.
   */
  accountPinterest?: Maybe<ScalarsEnums["String"]>;
  /**
   * Twitter Page URL.
   */
  accountTwitter?: Maybe<ScalarsEnums["String"]>;
  /**
   * YouTube Page URL.
   */
  accountYoutube?: Maybe<ScalarsEnums["String"]>;
  /**
   ...
   */
  facebookAdminId?: Maybe<ScalarsEnums["String"]>;
  /**
   * The Facebook app ID of the site&#039;s app. In order to use Facebook Insights you must add the app ID to your page.
   */
  facebookAppId?: Maybe<ScalarsEnums["String"]>;
  /**
   * Default Image for Open Graph.
   */
  facebookImg?: Maybe<MediaItem>;
  /**
   * Array of default facebook images all custom post types.
   */
  facebookImgCustomPostTypes?: Maybe<SEOPressSettings_FacebookImgCustomPostTypes>;
  /**
   * Use same image for all Open Graph tags.
   */
  facebookImgDefault?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * One or more Facebook Page IDs that are associated with a URL in order to enable link editing and instant article publishing. (Ref: https://www.facebook.com/help/1503421039731588)
   */
  facebookLinkOwnershipId?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable Open Graph Data.
   */
  facebookOg?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Contact option for knowledge graph (only for organizations). (Ref: https://schema.org/ContactPointOption)
   */
  knowledgeContactOption?: Maybe<ScalarsEnums["String"]>;
  /**
   * Contact type for knowledge graph (only for organizations). (Ref: https://schema.org/contactType)
   */
  knowledgeContactType?: Maybe<ScalarsEnums["String"]>;
  /**
   * Photo or logo for knowledge graph object.
   */
  knowledgeImg?: Maybe<MediaItem>;
  /**
   * Name of knowledge graph object.
   */
  knowledgeName?: Maybe<ScalarsEnums["String"]>;
  /**
   * Organization phone number for knowledge graph (only for organizations).
   */
  knowledgePhone?: Maybe<ScalarsEnums["String"]>;
  /**
   * The type of object for knowledge graph. (Ref: https://schema.org/Thing#subtypes)
   */
  knowledgeType?: Maybe<ScalarsEnums["String"]>;
  /**
   * Enable Twitter card
   */
  twitterCard?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Default Twitter card image,
   */
  twitterCardImg?: Maybe<MediaItem>;
  /**
   * Image size for twitter cards.
   */
  twitterCardImgSize?: Maybe<ScalarsEnums["String"]>;
  /**
   * Use Open Graph if no Twitter cards.
   */
  twitterCardOg?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Title and description format and whether should be marked as noindex for categories and taxonomies.
 */
export interface SEOPressSettings_TaxTitles {
  __typename?: "SEOPressSettings_TaxTitles";
  category?: Maybe<SEOPressSettings_TitleDescriptionNoindexNofollowDisable>;
  post_tag?: Maybe<SEOPressSettings_TitleDescriptionNoindexNofollowDisable>;
  productCategory?: Maybe<SEOPressSettings_TitleDescriptionNoindexNofollowDisable>;
  productTag?: Maybe<SEOPressSettings_TitleDescriptionNoindexNofollowDisable>;
}

/**
 * Title and Description Format.
 */
export interface SEOPressSettings_TaxonomiesList {
  __typename?: "SEOPressSettings_TaxonomiesList";
  category?: Maybe<SEOPressSettings_ShouldBeIncluded>;
  postTag?: Maybe<SEOPressSettings_ShouldBeIncluded>;
  productCategory?: Maybe<SEOPressSettings_ShouldBeIncluded>;
  productTag?: Maybe<SEOPressSettings_ShouldBeIncluded>;
}

/**
 * SEOPress hour and minute times.
 */
export interface SEOPressSettings_Time {
  __typename?: "SEOPressSettings_Time";
  /**
 ...
 * Title and Description Format.
 */
export interface SEOPressSettings_TitleDescriptionNoindex {
  __typename?: "SEOPressSettings_TitleDescriptionNoindex";
  date?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The default title format.
   */
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * Nofollow tag should be included.
   */
  nofollow?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noindex tag should be included.
   */
  noindex?: Maybe<ScalarsEnums["Boolean"]>;
  thumb_gcs?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The default title format.
   */
  title?: Maybe<ScalarsEnums["String"]>;
 ...
 * Title and Description Format.
 */
export interface SEOPressSettings_TitleDescriptionNoindexNofollow {
  __typename?: "SEOPressSettings_TitleDescriptionNoindexNofollow";
  /**
   * The default title format.
   */
  description?: Maybe<ScalarsEnums["String"]>;
 ...
 * Title and Description Format.
 */
export interface SEOPressSettings_TitleDescriptionNoindexNofollowDisable {
  __typename?: "SEOPressSettings_TitleDescriptionNoindexNofollowDisable";
  /**
   * The default title format.
   */
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * Should SEO metaboxes be disabled for this Taxonomy.
   */
  disable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Nofollow tag should be included.
   */
  nofollow?: Maybe<ScalarsEnums["Boolean"]>;
...
/**
 * SEOPress Titles and Metas settings pages.
 */
export interface SEOPressSettings_TitlesMetas {
  __typename?: "SEOPressSettings_TitlesMetas";
  /**
   * Customized metas for all archives.
   */
  archive_titles?: Maybe<SEOPressSettings_ArchiveTitles>;
  /**
   * Format of 404 page descriptions.
   */
  archives_404_desc?: Maybe<ScalarsEnums["String"]>;
  /**
   * Format of 404 page titles.
   */
  archives_404_title?: Maybe<ScalarsEnums["String"]>;
  /**
   * Format of author archive description.
   */
  archives_author_desc?: Maybe<ScalarsEnums["String"]>;
  /**
   * Author archive pages should be disabled.
   */
  archives_author_disable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noindex tag should be included on author archive pages.
   */
  archives_author_noindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Format of author archive title.
   */
  archives_author_title?: Maybe<ScalarsEnums["String"]>;
  /**
   * Format of archive date page descriptions.
   */
  archives_date_desc?: Maybe<ScalarsEnums["String"]>;
  /**
   * Archive date pages should be disabled.
   */
  archives_date_disable?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noindex tag should be included on archive date pages.
   */
  archives_date_noindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Format of archive date page titles.
   */
  archives_date_title?: Maybe<ScalarsEnums["String"]>;
  /**
   * Format of search page descriptions.
   */
  archives_search_desc?: Maybe<ScalarsEnums["String"]>;
  /**
   * Noindex tag should be included on archive date pages.
   */
  archives_search_noindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Format of search page titles.
   */
  archives_search_title?: Maybe<ScalarsEnums["String"]>;
  /**
   * Noindex tag should be included on attachment pages.
   */
  attachments_noindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * description 1
   */
  home_site_desc?: Maybe<ScalarsEnums["String"]>;
  /**
   * description 1
   */
  home_site_title?: Maybe<ScalarsEnums["String"]>;
  /**
   * Noarchive tag should be included on entire site.
   */
  noarchive?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Nofollow tag should be included on entire site.
   */
  nofollow?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noimageindex tag should be included on entire site.
   */
  noimageindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noindex tag should be included on entire site.
   */
  noindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Do not use Open Directory Project metadata on any pages.
   */
  noodp?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Nositelinkssearchbox tag should be included on entire site.
   */
  nositelinkssearchbox?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Nosnippet tag should be included on entire site.
   */
  nosnippet?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Noindex tag should be included on paginated pages.
   */
  paged_noindex?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Indicate paginated content to Google?
   */
  paged_rel?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Use this separator with %%sep%% in your title and meta description.
   */
  separator?: Maybe<ScalarsEnums["String"]>;
  /**
   * Formats of titles for posts and pages.
   */
  single_titles?: Maybe<SEOPressSettings_SingleTitles>;
  /**
   * Taxonomy page settings.
   */
  tax_titles?: Maybe<SEOPressSettings_TaxTitles>;
}

/**
 * SEOPress Tools settings pages.
 */
export interface SEOPressSettings_Tools {
  __typename?: "SEOPressSettings_Tools";
  /**
   * Is compatibility for Avia Layout Builder enabled.
   */
  compatibilityAviaLayout?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is compatibility for Divi Builder enabled.
   */
  compatibilityDivi?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is compatibility for Fusion Builder enabled.
   */
  compatibilityFusion?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is compatibility for Oxygen Builder enabled.
   */
  compatibilityOxygen?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is compatibility for WP Bakery enabled.
   */
  compatibilityWpBakery?: Maybe<ScalarsEnums["Boolean"]>;
}

/**
 * Which types of users should be excluded from tracking.
 */
export interface SEOPressSettings_WhoToTrack {
  __typename?: "SEOPressSettings_WhoToTrack";
  /**
   * Administrator should not be tracked.
   */
  administrator?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * author should not be tracked.
   */
  author?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * contributor should not be tracked.
   */
  contributor?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * subscriber should not be tracked.
   */
  customer?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * editor should not be tracked.
   */
  editor?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * subscriber should not be tracked.
...
/**
 * SEOPress XML - HTML Sitemap settings pages.
 */
export interface SEOPressSettings_XmlHtmlSitemap {
  __typename?: "SEOPressSettings_XmlHtmlSitemap";
  /**
   * Remove links from archive pages in HTML sitemaps.
   */
  htmlArchiveLinks?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Disable the display of the publication date in HTML sitemaps.
   */
  htmlDate?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Which posts, pages, custom post types, or terms should be excluded from sitemap?
   */
  htmlExclude?: Maybe<ScalarsEnums["String"]>;
  /**
   * Which post, page, or custom post type ID should be used to display the sitemap?
   */
  htmlMapping?: Maybe<ScalarsEnums["String"]>;
  /**
   * In which order should posts be sorted in HTML sitemap?
   */
  htmlOrder?: Maybe<ScalarsEnums["String"]>;
  /**
   * What should posts be sorted by in HTML sitemap?
   */
  htmlOrderby?: Maybe<ScalarsEnums["String"]>;
  /**
   * Which types of posts should be included in the sitemaps?
   */
  sitemapPostTypes?: Maybe<SEOPressSettings_PostTypesList>;
  /**
   * Which taxonomies should be included in the sitemaps?
   */
  sitemapTaxonomies?: Maybe<SEOPressSettings_TaxonomiesList>;
  /**
   * Is the XML sitemap for authors enabled?
   */
  xmlSitemapAuthorEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is the main XML sitemap enabled?
   */
  xmlSitemapGeneralEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is the HTML sitemap version enabled?
   */
  xmlSitemapHTMLEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is the XML sitemap for images enabled?
   */
  xmlSitemapImageEnabled?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Is the XML sitemap for images enabled?
   */
  xmlSitemapVideoEnabled?: Maybe<ScalarsEnums["Boolean"]>;
}
...
export interface Tag {
  ...
  /**
   * The SEOPress data of the Tags taxonomy.
   */
  seo?: Maybe<SEOPress>;
  /**
   * An alphanumeric identifier for the object unique to its type.
...
export interface TeamMember {
   ...
   */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  customSlug?: Maybe<ScalarsEnums["String"]>;
  /**
   * The unique identifier stored in the database
   */
  databaseId: ScalarsEnums["Int"];
  ...
  /**
   * The SEOPress data of the teamMember
   */
  seo?: Maybe<SEOPress>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
...
export interface Query {
  ...
  seoPressSettings?: Maybe<SEOPressSettings>;
...
export interface SchemaObjectTypes {
  ...
  SEOPress: SEOPress;
  SEOPressSettings: SEOPressSettings;
  SEOPressSettings_Advanced: SEOPressSettings_Advanced;
  SEOPressSettings_AdvancedUserEnable: SEOPressSettings_AdvancedUserEnable;
  SEOPressSettings_Analytics: SEOPressSettings_Analytics;
  SEOPressSettings_ArchiveTitles: SEOPressSettings_ArchiveTitles;
  SEOPressSettings_BreadcrumbCptList: SEOPressSettings_BreadcrumbCptList;
  SEOPressSettings_BreadcrumbCptShow: SEOPressSettings_BreadcrumbCptShow;
  SEOPressSettings_BreadcrumbTaxonomiesList: SEOPressSettings_BreadcrumbTaxonomiesList;
  SEOPressSettings_BreadcrumbTaxonomiesShow: SEOPressSettings_BreadcrumbTaxonomiesShow;
  SEOPressSettings_BusinessDays: SEOPressSettings_BusinessDays;
  SEOPressSettings_FacebookImgCustomPostTypes: SEOPressSettings_FacebookImgCustomPostTypes;
  SEOPressSettings_FacebookImgDefault: SEOPressSettings_FacebookImgDefault;
  SEOPressSettings_GoogleNewsPostTypes: SEOPressSettings_GoogleNewsPostTypes;
  SEOPressSettings_GoogleNewsPostTypesEnabled: SEOPressSettings_GoogleNewsPostTypesEnabled;
  SEOPressSettings_OpenHours: SEOPressSettings_OpenHours;
  SEOPressSettings_OpenHoursAmPm: SEOPressSettings_OpenHoursAmPm;
  SEOPressSettings_PostTypesList: SEOPressSettings_PostTypesList;
  SEOPressSettings_Pro: SEOPressSettings_Pro;
  SEOPressSettings_ShouldBeIncluded: SEOPressSettings_ShouldBeIncluded;
  SEOPressSettings_SingleTitles: SEOPressSettings_SingleTitles;
  SEOPressSettings_SocialNetworks: SEOPressSettings_SocialNetworks;
  SEOPressSettings_TaxTitles: SEOPressSettings_TaxTitles;
  SEOPressSettings_TaxonomiesList: SEOPressSettings_TaxonomiesList;
  SEOPressSettings_Time: SEOPressSettings_Time;
  SEOPressSettings_TitleDescriptionNoindex: SEOPressSettings_TitleDescriptionNoindex;
  SEOPressSettings_TitleDescriptionNoindexNofollow: SEOPressSettings_TitleDescriptionNoindexNofollow;
  SEOPressSettings_TitleDescriptionNoindexNofollowDisable: SEOPressSettings_TitleDescriptionNoindexNofollowDisable;
  SEOPressSettings_TitlesMetas: SEOPressSettings_TitlesMetas;
  SEOPressSettings_Tools: SEOPressSettings_Tools;
  SEOPressSettings_WhoToTrack: SEOPressSettings_WhoToTrack;
  SEOPressSettings_XmlHtmlSitemap: SEOPressSettings_XmlHtmlSitemap;
